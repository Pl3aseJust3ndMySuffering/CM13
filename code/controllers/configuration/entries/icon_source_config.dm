...
/datum/config_entry/string/alien_embryo
...
/datum/config_entry/string/alien_crusher
	config_entry_value = "icons/mob/hostiles/crusher.dmi"

/datum/config_entry/string/alien_lurker
...
/datum/config_entry/string/alien_spitter
