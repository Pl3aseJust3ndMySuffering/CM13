...
/obj/item/clothing/suit/storage/marine/rnd/coat
	name = "\improper RnD Full-suit"
	desc = "Coat with almost no protection in exchange for mobility. Made in RnD. Synthetic programming compliant."
